...
public class FlutterHeicToJpgPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "flutter_heic_to_jpg", binaryMessenger: registrar.messenger())
    let instance = FlutterHeicToJpgPlugin()
